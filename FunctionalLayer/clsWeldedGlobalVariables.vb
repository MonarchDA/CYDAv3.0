...
#Region "Public Properties"
    ...
    Public strPortAngle As String = String.Empty                    'priyanka
    Private _StrBEDLPartCode As String                              'priyanka
    Public tmpPortType As String = Nothing                          'Priyanka
    Public tmpPortSize As String = Nothing                          'Priyanka
...
#Region "Tube Details"
    ...
    Public Property BEDLPartCode() As String
        Get
...
#End Region
    ...
    Public Function GetWC_619_622() As String
        Try
            ...
            'If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.DesignType = "Conventional" AndAlso _   ' Priyanka
            ...
            (ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodLength - ObjClsWeldedCylinderFunctionalClass.ObjFrmRetractedLengthValidation.Dim8FromPistonEndofRod) >= 10.75 AndAlso _
             ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.OriginalTubeLength <= 54 AndAlso _
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth <= 6.75 AndAlso _
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.StrokeLength >= 8 AndAlso _
    ...
    Public Function ECR_NewPartsUpdation_ReleaseMenuItem(ByRef oClsReleaseCylinderFunctionality As clsReleaseCylinderFunctionality) As Boolean
        ...
        Try
            ...
            If IsNothing(drECR_Details) = False OrElse drECR_Details.ItemArray.Length > 0 Then
                ...
                My.Computer.FileSystem.MoveDirectory(" K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\CMS\" & ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CodeNumber.ToString & "_CMS", "W:\WELDED\CMS\" & ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CodeNumber.ToString & "_CMS")     '25TH JUNE 2013   VAMSI
                ...
                If File.Exists("K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\CNC\" & "0" & strRodWeldment & "1.MIN") Then
                    File.Delete("K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\CNC\" & "0" & strRodWeldment & "1.MIN")
                End If
                My.Computer.FileSystem.MoveFile("C:\WELDED_TESTING\CNC_TEMP\" & "0" & strRodWeldment & "1.MIN", "K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\CNC\" & "0" & strRodWeldment & "1.MIN")
