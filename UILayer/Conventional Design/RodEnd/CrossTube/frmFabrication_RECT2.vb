Imports System.io
Public Class frmFabrication_RECT2
...
#Region "Sub Procedures"
    ...
    Private Sub LoadDefaultValues()
      ...
      OrElse ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd <> _dblCrossTubeWidth Then
            ...
            ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation_RodEnd _
                       ...
                       clsWeldedCylinderFunctionalClass.YeildStrengthConstants.CrossTube, "2")          '24_07_2012    RAGAVA

            ''17-02-10 Sandeep
            'ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation_RodEnd _
            '       (ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, _
            '       clsWeldedCylinderFunctionalClass.YeildStrengthConstants.CrossTube, "2")          '24_07_2012    RAGAVA
            '_dblTempSwingClearance = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance_RodEnd2
            ''17-02-10 Sandeep
            ...
            _dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2
            _rodDiameter = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodDiameter


            txtCrossTubeOD_DesignCrossTubeCT_RECT.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeOD_RodEnd2
            txtCrossTubeWidth_DesignCrossTubeCT_RECT.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2
            ...
            txtSwingClearance_DesignCrossTubeCT_RECT.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance_RodEnd2
    ...
    Private Sub SearchForExistingCrossTube()
        Dim dblRequiredCrossTubeWidth As Double = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2
        ...
        Dim dblRequiredSwingClearance As Double = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance_RodEnd2
    ...
    Private Sub PopulateDataInListView()
        ...
        lvwExistingCrossTubeListView_RECT.Clear()
        lvwExistingCrossTubeListView_RECT.Columns.Add("Code No", 70, HorizontalAlignment.Center)
        lvwExistingCrossTubeListView_RECT.Columns.Add("Description", 245, HorizontalAlignment.Center)

        'TODO:Anup 09-04-10 2pm
        lvwExistingCrossTubeListView_RECT.Columns.Add("SafetyFactor", 50, HorizontalAlignment.Center)
        '***********

        lvwExistingCrossTubeListView_RECT.Columns.Add("Cost", 60, HorizontalAlignment.Center)
    ...
    Private Sub WidthCalculation()
        ...
        ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation_RodEnd(dblSafetyFactor, clsWeldedCylinderFunctionalClass.YeildStrengthConstants.CrossTube, "2")          '24_07_2012    RAGAVA
        'txtCrossTubeOD_DesignCrossTubeCT_RECT.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeOD
        txtCrossTubeOD_DesignCrossTubeCT_RECT.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeOD_RodEnd2    '02_02_2011   RAGAVA
    End Sub
...
#Region "Events"
    ...
    Private Sub lvwExistingCrossTubeListView_RECT_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvwExistingCrossTubeListView_RECT.SelectedIndexChanged
        ...
        If lvwExistingCrossTubeListView_RECT.SelectedIndices.Count > 0 Then
            ...
            Try
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SafetyFactor_RodEnd2 = oListViewSelectedItem.SubItems(2).Text      '31_05_2011   ragava
            Catch ex As Exception
            End Try
           ...
           GetRECrossTubeDetailsSelectedRowDetails(strPartCodePassing_Purchased)
            ...
            If Not IsNothing(oSelectedCrossTubeDataRow) Then
                ...
                If Not IsDBNull(oSelectedCrossTubeDataRow("PartCode")) Then
                    ...
                    '1_03_2010 Aruna
                    ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationCode_RodEnd2 = oSelectedCrossTubeDataRow("PartCode")
                End If
            End If
            'ANUP 07-10-2010 TILL HERE
            ...
            If Not IsDBNull(oSelectedCrossTubeDataRow("Diameter")) Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance_RodEnd2 = txtSwingClearance_RECT.Text
            End If
            ...
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.REDistanceFromPinholetoRodStop2 = Val(txtCrossTubeOD_RECT.Text) / 2 'oSelectedCastingDataRow("DistancefromPinholetoRodStop")
            If oSelectedCrossTubeDataRow("PartType").ToString.Contains("IFL_PART") Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodEndPartName2 = "Rod_Crosstube_IFL"
            Else
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationDesign_RodEnd2 = "Existing"
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodEndPartName2 = "Base_Cross_Tube"
            End If
            '1_03_2010 Aruna
            ObjClsWeldedCylinderFunctionalClass.strRE_Cast_Fabricated2 = "Fabricated"
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationDesignType_RodEnd2 = "Fabricated"
    ...
    Private Sub btnGenerateCT_RECT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerateCT_RECT.Click
        ...
        Try
            ...
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationDesignType_RodEnd2 = "Fabricated"
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.REDistanceFromPinholetoRodStop2 = Val(txtCrossTubeOD_DesignCrossTubeCT_RECT.Text) / 2
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeOD_RodEnd2 = Val(txtCrossTubeOD_DesignCrossTubeCT_RECT.Text)
            ...
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodEndPartName2 = "ROD_CROSSTUBE_IFL"            '25_07_2012    RAGAVA
    ...
    Private Sub btnAcceptCT_RECT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAcceptCT_RECT.Click
        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodEndFabricationSelected2 = True            '24_07_2012   RAGAVA
        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.REDistanceFromPinholetoRodStop2 = Val(txtCrossTubeOD_DesignCrossTubeCT_RECT.Text) / 2
        ' ObjClsWeldedCylinderFunctionalClass.TxtCrossTubeWidth_BaseEnd.Text = txtCrossTubeOD_DesignCrossTubeCT_RECT.Text
        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationDesign_RodEnd2 = "NewDesign" '1_03_2010
        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationDesignType_RodEnd2 = "Fabricated"
        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnExistingPartSelected_RodEnd2 = False        '15_02_2011   RAGAVA
        ObjClsWeldedCylinderFunctionalClass.IsExact_NewDesign_Resize_RodEnd2 = ""                                      '15_02_2011   RAGAVA
        ObjClsWeldedCylinderFunctionalClass.NextClick.Enabled = True
        btnAcceptCT_RECT.Enabled = False
        If txtSafetyFactor_DesignCrossTubeCT_RECT.Text <> "" Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SafetyFactor_RodEnd2 = txtSafetyFactor_DesignCrossTubeCT_RECT.Text         '31_05_2011  RAGAVA
        End If

        '24-05-2012 MANJULA ADDED
        ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT._dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2
        ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2._dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2
        ObjClsWeldedCylinderFunctionalClass.ObjFrmRECrossTube._dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2
        ObjClsWeldedCylinderFunctionalClass.ObjFrmRECrossTube2._dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2
        '**********************
    End Sub
    ...
    Private Sub txtCrossTubeWidth_DesignCrossTubeCT_RECT_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCrossTubeWidth_DesignCrossTubeCT_RECT.Leave
        ...
        If txtCrossTubeWidth_DesignCrossTubeCT_RECT.Text <> "" Then
            If txtCrossTubeWidth_DesignCrossTubeCT_RECT.Text <> txtCrossTubeWidth_DesignCrossTubeCT_RECT.IFLDataTag Then
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2 = Val(txtCrossTubeWidth_DesignCrossTubeCT_RECT.Text)         '25_07_2012   RAGAVA
    ...
    Private Sub ActivateNewDesignGroupBox()
        ...
        ObjClsWeldedCylinderFunctionalClass.NextClick.Enabled = False
        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnExistingPartSelected_RodEnd2 = False          '14_02_2011   RAGAVA
    ...
    Private Sub rdbExactMatchYes_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbExactMatchYes.CheckedChanged
        ...
        If rdbExactMatchYes.Checked Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodEndfabricationSelected2 = False        '24_07_2012   RAGAVA
    ...
    Private Sub UpdatePreviousFormDetails()
        ...
        If txtCrossTubeOD_RECT.Text <> "" Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeOD_RodEnd2 = Val(txtCrossTubeOD_RECT.Text)
        End If

        If txtCrossTubeWidth_RECT.Text <> "" Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth_RodEnd2 = Val(txtCrossTubeWidth_RECT.Text)
        End If

        If txtSwingClearance_RECT.Text <> "" Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance_RodEnd2 = Val(txtSwingClearance_RECT.Text)
        End If
