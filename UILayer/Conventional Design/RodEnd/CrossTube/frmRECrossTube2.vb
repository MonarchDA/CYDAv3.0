...
RodWeldValidation:  '04_05_2011  RAGAVA
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.Enabled = False
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.btnPleaseChangeTheRodDiameter.Visible = True
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.btnPleaseChangeTheRodDiameter.BringToFront()
            End If
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.MatchedRECrossTubeCastingDataTable.Rows.Count > 0 Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingYes_RECT2.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingYes_RECT2.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingYes_RECT2.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingYes_RECT2.Show()
                pnlRECTCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingYes_RECT2)
            Else
                pnlRECTCasting_YesNo.Controls.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.Show()
                pnlRECTCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2)
            End If
...
#Region "Events"
    ...
    Private Sub frmRECrossTube_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT2.IsPrimaryInputsReq = False
        ' SearchForExistingCrossTubeCastingsRE()
        SetValuesToPrivateVariables()
    End Sub
