...
#Region "SubProcedures"
    ...
    Private Sub SetValuesToPrivateVariables()
        If ObjClsWeldedCylinderFunctionalClass.IsAnyValueChangedWhileRevision() Then
            IsPopulated = True
        End If
        If ObjClsWeldedCylinderFunctionalClass.ObjFrmDLCastingNo_PortInTube2.rdbFabrication.Checked = False AndAlso ObjClsWeldedCylinderFunctionalClass.ObjFrmDLCastingNo_PortInTube2.rdbDesignACasting.Checked = True Then       '30_05_2012   RAGAVA
            ...
            ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strCast_Fabricated_1st = "Fabrication" Then 'AndAlso _
                ...
                rdbFabrication.Checked = False
                rdbFabrication.Enabled = True  'vamsi 21st may 13
    ...
    Private Sub chkULug_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkULug.CheckedChanged
        Try
            ...
            If ObjClsWeldedCylinderFunctionalClass.MultiGenerate = True Then
                ObjClsWeldedCylinderFunctionalClass.Fabricated_2_batchrun = True
            End If
            '----------------------------------------------------------------------009
        Catch ex As Exception
