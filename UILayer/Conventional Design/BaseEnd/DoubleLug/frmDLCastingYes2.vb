...
#Region "Subprocedures"
    ...
    Sub updatedlcastdetails()
        If txtSwingClearance.Text <> "" Then
            ...
            ' End If
            ObjClsWeldedCylinderFunctionalClass.TxtSwingClearance_BaseEnd.Text = txtSwingClearance.Text        '21_06_2012   RAGAVA
            'Till  Here
        End If
        '15_05_2012    RAGAVA
        '20_04_2012   RAGAVA            
...
#Region "Events"
    ...
    Private Sub lvwCastingListView_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvwDoubleLugListView.SelectedIndexChanged
        ...
        If lvwDoubleLugListView.SelectedIndices.Count > 0 Then
            ...
            Catch ex As Exception
            End Try
            ObjClsWeldedCylinderFunctionalClass.strExistingBaseEndPartCode2 = strPartCodePassing_Purchased         '15_05_2012    RAGAVA
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strBaseEndCastingCodeNumber = ObjClsWeldedCylinderFunctionalClass.strExistingBaseEndPartCode2    '15_05_2012    RAGAVA
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port In Tube" Then
                ...
                oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                           GetBEDLCastWithOutPortSelectedRowDetails(strPartCodePassing_Purchased, "2")         '15_05_2012   RAGAVA
            ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                ...
                If UCase(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.PortInsertion) = "RAISED" Then
                    ...
                    If ObjClsWeldedCylinderFunctionalClass.strPortAngle_BaseEnd = "Straight" Then
                        oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                                                        GetBEDLCastingWithRaisedPortSelectedRowDetails(strPartCodePassing_Purchased, "2")         '15_05_2012   RAGAVA
                    Else
                        oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                                GetBEDLCastingWithRaisedPortSelectedRowDetails90(strPartCodePassing_Purchased, "2")         '15_05_2012   RAGAVA
                    End If
                    'Till   Here
                Else
                    'oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                    ...
                    oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                               GetBEDLCastingWithFlushedPortSelectedRowDetails(strPartCodePassing_Purchased, "2")         '15_05_2012   RAGAVA
                End If
                'oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
            ...
            If Not IsNothing(oSelectedCastingDataRow) Then
                If Not IsDBNull(oSelectedCastingDataRow("PartCode")) Then
                    ...
                    ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationCode_BaseEnd2 = oSelectedCastingDataRow("PartCode") '15_05_2012    RAGAVA
                ...
                If Not IsDBNull(oSelectedCastingDataRow("DistancefromPinHoletoRodStop")) Then
                    ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndDistanceFromPinholetoRodStop2 = oSelectedCastingDataRow("DistancefromPinHoletoRodStop") '15_05_2012    RAGAVA
                End If
                'Anup END
            End If
            rdbUseSelectedSingleLugYes.Checked = True   'anup 22-12-2010 
    ...
    Private Sub rdbUseSelectedSingleLugYes_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbUseSelectedSingleLugYes.CheckedChanged
        If rdbUseSelectedSingleLugYes.Checked Then
            ...
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugWidth2 = Val(txtLugsWidth.Text)                      'Check
    ...
    Private Sub rdbUseSelectedSingleLugNo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbUseSelectedSingleLugNo.CheckedChanged
        Try
            If rdbUseSelectedSingleLugNo.Checked Then
                ...
                '05_06_2012   RAGAVA
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness2 = Val(ObjClsWeldedCylinderFunctionalClass.ObjFrmTubeDetails.txtLugThickness.Text)
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance2 = Val(ObjClsWeldedCylinderFunctionalClass.ObjFrmTubeDetails.txtSwingClearance.Text)
                'MANJULA ADDED
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmDLPortIntegral.dblRequiredLugThickness = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness2
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmDLPortIntegral2.dblRequiredLugThickness = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness2
