Public Class frmBHFabrication2
...
#Region "Sub Procedures"
    ...
    Private Sub LoadDefaultvalues()
       ...
       OrElse ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness <> _dblLugThickness Then
           ...
           (ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, Me.chkOptimizer.Checked, _
                       clsWeldedCylinderFunctionalClass.YeildStrengthConstants.BH, "2")    '28_06_2012   RAGAVA
        ...
        Try
            ...
            If Not IsNothing(oClevisPlateDetails) AndAlso oClevisPlateDetails.Rows.Count > 0 Then
                ...
                Else
                    ...
                    '3_3_2010 Aruna
                    ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ClevisPlateThickness2 = oPlateClevisDatarow("StandardClevisPlateThickness") - oPlateClevisDatarow("StandardClevisPlateRodStopDistance") '06_04_2010 Aruna
    ...
    Private Sub SearchForExistingBH()
        ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation(ObjClsWeldedCylinderFunctionalClass. _
                                            ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, False, clsWeldedCylinderFunctionalClass.YeildStrengthConstants.BH, "2")      '28_06_2012    RAGAVA
        ...
        Try
            ...
            BEBHDetails(dblBushingQuantity, dblBushingWidth, dblRequiredPinHoleSize, dblRequiredLugThickness, strPinWithInTubeDia, dblTubeOD, dblRequiredSwingClearance, "Base End", "2")      '02_07_2012   RAGAVA
            ...
            If Not IsNothing(oBHDataTable) AndAlso oBHDataTable.Rows.Count > 0 Then
                ...
                For Each oFilterWithAreaDataRow2Row As DataRow In oBHDataTable.Rows
                    ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation(ObjClsWeldedCylinderFunctionalClass. _
                    ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, False, oFilterWithAreaDataRow2Row("YieldStrength"), "2")   '28_06_2012   RAGAVA
    ...
    Private Sub WidthCalculation()
        Try
            Dim dblSafetyFactor As Double = trbSafetyFactor.Minimum + ((trbSafetyFactor.Value - trbSafetyFactor.Minimum) * 0.25)
            txtSafetyFactor_DesignBH.Text = dblSafetyFactor
            ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation(dblSafetyFactor, Me.chkOptimizer.Checked, clsWeldedCylinderFunctionalClass.YeildStrengthConstants.BH, "2")    '28_06_2012   RAGAVA
    ...
    Private Sub ValidLugThickness()
        Try
            ...
            End If
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness2 = Val(txtLugThickness_DesignBH.Text)     '28_06_2012   RAGAVA
        Catch ex As Exception
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        Try
            ...
            If ObjClsWeldedCylinderFunctionalClass.IsPortIntegral_or_PortInTube = "Port In Tube" Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndDistanceFromPinholetoRodStop2 = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance + ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ClevisPlateThickness2 'TODO: ANUP 02-06-2010
            End If
            ...
            If txtSwingClearance_DesignBH.Text <> "" Then
                'ObjClsWeldedCylinderFunctionalClass.TxtSwingClearance_BaseEnd.Text = txtSwingClearance_DesignBH.Text    '02_07_2012   RAGAVA Commented
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance2 = Val(txtSwingClearance_DesignBH.Text)
            End If
            If txtLugThickness_DesignBH.Text <> "" Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness2 = Val(txtLugThickness_DesignBH.Text)
            End If
                ...
                If Not IsNothing(oSelectedULugDataRow) Then
                    Try
                        ...
                        Else
                            ...
                            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPartName2 = "Base_BH_LUG"
                        End If
    ...
    Private Sub rdbUseSelectedBH_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbUseSelectedBH.CheckedChanged
        If rdbUseSelectedBH.Checked Then
            ...
            If MessageBox.Show(strMessage, "Update TubeDetails", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.OK Or ObjClsWeldedCylinderFunctionalClass.MultiGenerate = True Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndConfigurationDesignType2 = "Fabricated"               'Check
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEnd_NewDesign_TableName2 = "WELDED.BEBHDetails"
            End If
        End If
    End Sub
