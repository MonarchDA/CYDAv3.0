...
#Region "Sub Procedures"
    ...
    Public Sub updatePreviousFormDetails1()
        If txtSwingClearance.Text <> "" Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance = Val(txtSwingClearance.Text)     '28_06_2012    RAGAVA
        ...
        If txtGreaseZerk.Text <> "" AndAlso txtGreaseZerk.Text <> "N/A" Then
            ...
            ObjClsWeldedCylinderFunctionalClass.CmbGreaseZercs_BaseEnd.Text = txtRequiredGreaseZerk.Text
        End If
            ...
            If lvwBHListView.SelectedIndices.Count > 0 Then
                ...
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port In Tube" Then
                    oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                GetBEBHCastWithOutPortSelectedRowDetails(strPartCodePassing_Purchased)
                ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                    ...
                    Else
                        oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
            GetBEBHCastingWithFlushedPortSelectedRowDetails(oListViewSelectedItem.SubItems(BHListViewDetails.CodeNumber).Text)
                    End If
                    'Till   Here
                End If
                ...
                If Not IsNothing(oSelectedCastingDataRow) Then
                    Try
                        ...
                        Else
                            ...
                            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPartName = "BH_No_Port"
                        End If
    ...
    Private Sub rdbUseSelectedBHYes_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbUseSelectedBHYes.CheckedChanged
        If rdbUseSelectedBHYes.Checked Then
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral.rdbDesignACasting.Checked = True
            ...
            ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port In Tube" Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.rdbDesignACasting.Checked = True
            ...
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness = Val(txtLugThickness.Text)      '28_06_2012    RAGAVA
            'ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance = Val(txtSwingClearance.Text)      '28_06_2012    RAGAVA
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugWidth = Val(txtLugsWidth.Text)            '28_06_2012    RAGAVA
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
    ...
    Private Sub rdbUseSelectedBHNo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbUseSelectedBHNo.CheckedChanged
        If rdbUseSelectedBHNo.Checked Then
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral.rdbFabricated.Checked = False
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral.rdbDesignACasting.Enabled = True
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral.rdbFabricated.Enabled = True
            ...
            ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port In Tube" Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.rdbFabrication.Checked = False
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.rdbDesignACasting.Enabled = True
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.rdbFabrication.Enabled = True
            ...
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness = Val(ObjClsWeldedCylinderFunctionalClass.ObjFrmTubeDetails.txtLugThickness.Text)      '28_06_2012    RAGAVA
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance = Val(ObjClsWeldedCylinderFunctionalClass.ObjFrmTubeDetails.txtSwingClearance.Text)  '28_06_2012    RAGAVA
