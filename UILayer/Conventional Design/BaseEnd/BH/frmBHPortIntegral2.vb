Public Class frmBHPortIntegral2
...
#Region "Sub Procedures"
    ...
    Private Sub SearchForExistingBHCastings()
        ...
        If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strCast_Fabricated_1st = "Cast" Then
            ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.rdbDesignACasting.Enabled = False
            ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.rdbFabricated.Enabled = True
        Else
            ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.rdbFabricated.Enabled = False
            ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.rdbDesignACasting.Enabled = True
        End If
        'Till   Here
        ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation(ObjClsWeldedCylinderFunctionalClass. _
                        ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, False, clsWeldedCylinderFunctionalClass.YeildStrengthConstants.SingleLug_Cast_FlushedPort, "2")   '02_07_2012   RAGAVA
        ...
        Try
                ...
                If ObjClsWeldedCylinderFunctionalClass.strPortAngle_BaseEnd = "Straight" Then
                    oBEBHCastingWithPortDetails = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                                BEBHCastingWithRaisedPortDetails(_dblTempBoreDiameter, _dblTempWallThickness, _dblTempBushingWidth, _dblTempPinHoleSize, _dblTempBushingQuantity, _dblTempLugThickness, _
                                                 _dblTempSwingClearance, _strTempPortType, "2")   '02_07_2012   RAGAVA
                Else
                    oBEBHCastingWithPortDetails = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
            ...
            Else
                pnlBHCasting_YesNo.Controls.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2.Show()
                pnlBHCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortIntegral2)
