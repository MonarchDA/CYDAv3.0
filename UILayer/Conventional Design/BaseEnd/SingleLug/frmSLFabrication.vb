...
#Region "Sub Procedures"
    ...
    Private Sub LoadDefaultvalues()
       ...
       OrElse ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness <> _dblLugThickness Then
            ...
            'lvwSafetyFactor_Weight.Items.Clear() MANJULA COMMENTED
            ObjClsWeldedCylinderFunctionalClass.NextClick.Enabled = False
           ...
           (ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, Me.chkOptimizer.Checked, _
                       clsWeldedCylinderFunctionalClass.YeildStrengthConstants.SingleLug)
    ...
    Private Sub SearchForExistingSingleLug()
        ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation(ObjClsWeldedCylinderFunctionalClass. _
                                            ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, False, clsWeldedCylinderFunctionalClass.YeildStrengthConstants.SingleLug)
        ...
        Try
            ...
            BESingleLUgDetails(dblBushingQuantity, dblBushingWidth, dblRequiredPinHoleSize, dblRequiredLugThickness, strPinWithInTubeDia, dblTubeOD, dblRequiredSwingClearance, "Base End")
    ...
    Private Sub WidthCalculation()
        Try
            Dim dblSafetyFactor As Double = trbSafetyFactor.Minimum + ((trbSafetyFactor.Value - trbSafetyFactor.Minimum) * 0.25)
            txtSafetyFactor_DesignSingleLug.Text = dblSafetyFactor
            ObjClsWeldedCylinderFunctionalClass.Area_Y_LugWidth_LugThickness_Calculation(dblSafetyFactor, Me.chkOptimizer.Checked, clsWeldedCylinderFunctionalClass.YeildStrengthConstants.SingleLug)     '12_11_2009   Ragava
            txtLugWidth_DesignSingleLug.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugWidth
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        Try
            ...
            If txtSwingClearance_DesignSingleLug.Text <> "" Then
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance = Val(txtSwingClearance_DesignSingleLug.Text)       '18_07_2012   RAGAVA
            End If
            ...
            If txtLugThickness_DesignSingleLug.Text <> "" Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness = Val(txtLugThickness_DesignSingleLug.Text)        '18_07_2012   RAGAVA
            End If
                ...
                If Not IsNothing(oSelectedULugDataRow) Then
                    Try
                        ...
                        Else
                            ...
                            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPartName = "Base_Lug_single"
                        End If
