    ...
    Private Sub SearchForExistingSingleLugCastings()
        Try
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.MatchedBESLCastingDataTable.Rows.Count > 0 Then
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingYes.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingYes.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingYes.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingYes.Show()
                pnlSLCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingYes)
            ...
            Else
                ...
                pnlSLCasting_YesNo.Controls.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortInTube.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortInTube.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortInTube.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortInTube.Show()
                pnlSLCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortInTube)
