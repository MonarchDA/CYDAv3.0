Public Class frmSLPortIntegral
...
#Region "Sub Procedures"
    ...
    Private Sub SearchForExistingSingleLugCastings()
        ...
        Try
            ...
            Else
                pnlSLCasting_YesNo.Controls.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortIntegral.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortIntegral.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortIntegral.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortIntegral.Show()
                pnlSLCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortIntegral)
