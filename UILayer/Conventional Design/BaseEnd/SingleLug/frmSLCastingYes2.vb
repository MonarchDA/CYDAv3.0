            ...
            If lvwSingleLugListView.SelectedIndices.Count > 0 Then
                ...
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port In Tube" Then
                    oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                GetBESLCastWithOutPortSelectedRowDetails(strPartCodePassing_Purchased, "2")    '18_07_2012   RAGAVA
                ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                    ...
                    If UCase(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.PortInsertion) = "RAISED" Then
                        ...
                        If ObjClsWeldedCylinderFunctionalClass.strPortAngle_BaseEnd = "Straight" Then
                            oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.GetBESLCastingWithRaisedPortSelectedRowDetails(strPartCodePassing_Purchased, "2")    '18_07_2012   RAGAVA
                        Else
                            oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.GetBESLCastingWithRaisedPortSelectedRowDetails90(strPartCodePassing_Purchased, "2")    '18_07_2012   RAGAVA
                        End If
                        'Till    Here
                    Else
                        oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
            GetBESLCastingWithFlushedPortSelectedRowDetails(oListViewSelectedItem.SubItems(SingleLugListViewDetails.CodeNumber).Text, "2")    '18_07_2012   RAGAVA
                    End If
                    'Till   Here
                End If
                ...
                If Not IsNothing(oSelectedCastingDataRow) Then
                    Try
                        ...
                        If Not IsDBNull(oSelectedCastingDataRow("PartCode")) Then
                            ...
                            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationCode_BaseEnd2 = oSelectedCastingDataRow("PartCode")
