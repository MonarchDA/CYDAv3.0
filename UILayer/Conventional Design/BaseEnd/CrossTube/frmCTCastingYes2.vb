...
#Region "Sub Procedures"
    ...
    Private Sub LoadFunctionality()
        ...
        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndConfigurationDesignType2 = "Cast"    '12_07_2012   RAGAVA 
...
#Region "Events"
    ...
    Private Sub lvwCrossTubeListView_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvwCrossTubeListView.SelectedIndexChanged
        ...
        Try
            If lvwCrossTubeListView.SelectedIndices.Count > 0 Then
                ...
                Catch ex As Exception
                End Try
                ObjClsWeldedCylinderFunctionalClass.strExistingBaseEndPartCode2 = strPartCodePassing_Purchased    '12_07_2012   RAGAVA          '12_10_2010   RAGAVA
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strBaseEndCastingCodeNumber = ObjClsWeldedCylinderFunctionalClass.strExistingBaseEndPartCode2      '07_02_2011 
                ...
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port In Tube" Then
                    oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                GetBECrossTubeCastWithOutPortSelectedRowDetails(strPartCodePassing_Purchased, "2")    '12_07_2012   RAGAVA 
                ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                    ...
                    If UCase(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.PortInsertion) = "RAISED" Then
                        If ObjClsWeldedCylinderFunctionalClass.strPortAngle_BaseEnd = "Straight" Then          '19_05_2010   RAGAVA     NEW DESIGN
                            oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                                            GetBECrossTubeCastRaisedPortSelectedRowDetails(strPartCodePassing_Purchased, "2")    '12_07_2012   RAGAVA 
                            '19_05_2010   RAGAVA     NEW DESIGN
                        Else
                            oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                                                                       GetBECrossTubeCastRaisedPortSelectedRowDetails90(strPartCodePassing_Purchased, "2")    '12_07_2012   RAGAVA 
                        End If
                        'Till   Here
                    Else
                        oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                                GetBECrossTubeCastFlushPortSelectedRowDetails(oListViewSelectedItem.SubItems(CrossTubeListViewDetails.CodeNumber).Text, "2")    '12_07_2012   RAGAVA 
                    End If
                    'oSelectedCastingDataRow = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass. _
                ...
                If Not IsNothing(oSelectedCastingDataRow) Then
                    If Not IsDBNull(oSelectedCastingDataRow("PartCode")) Then
                        ...
                        '1_03_2010 Aruna
                        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ConfigurationCode_BaseEnd2 = oSelectedCastingDataRow("PartCode")    '12_07_2012   RAGAVA 
                    ...
                    If Not IsDBNull(oSelectedCastingDataRow("DistanceFromTubeEdgeToRodStop")) Then
                        ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.EndofTubetoRodStop2 = oSelectedCastingDataRow("DistanceFromTubeEdgeToRodStop")
                    End If
            ...
            Else
                ...
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndDistanceFromPinholetoRodStop2 = 0    '12_07_2012   RAGAVA 
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.EndofTubetoRodStop2 = 0    '12_07_2012   RAGAVA 
            End If
        Catch ex As Exception
    ...
    Private Sub rdbResize_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbResize.CheckedChanged
        '26_02_2010 Aruna Start
        ObjClsWeldedCylinderFunctionalClass.IsExact_NewDesign_Resize2 = ""        '12_07_2012   RAGAVA 
        If rdbResize.Checked Then
            ...
            ObjClsWeldedCylinderFunctionalClass.IsExact_NewDesign_Resize2 = "Resize"    '12_07_2012   RAGAVA 
    ...
    Private Sub rdbNewCasting_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbNewCasting.CheckedChanged
        ...
        If rdbNewCasting.Checked Then
            ...
            ObjClsWeldedCylinderFunctionalClass.IsExact_NewDesign_Resize2 = "NewDesign"    '12_07_2012   RAGAVA 
            UpdatePreviousFormDetails()
            ObjClsWeldedCylinderFunctionalClass.NextClick.Enabled = True
        End If
        '26_02_2010 Aruna Ends
    ...
    Private Sub rdbExactMatchYes_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbExactMatchYes.CheckedChanged
        ...
        If rdbExactMatchYes.Checked Then
            ...
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnExistingPartSelected_BaseEnd = True        '20_10_2010    RAGAVA
            ObjClsWeldedCylinderFunctionalClass.IsExact_NewDesign_Resize2 = "Exact"    '12_07_2012   RAGAVA 
            ' grbNotExactMatch.Visible = False
            UpdatePreviousFormDetails()
            ObjClsWeldedCylinderFunctionalClass.NextClick.Enabled = True
        End If
    ...
    Private Sub UpdatePreviousFormDetails()
        '----------------------------------------------------------------------------------------------------009 loop added to facilitate batchrun
    ...
    Private Sub UpdateValues()
        ...
        If txtCrossTubeWidth.Text <> "" Then
            ...
            'ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strCast_Fabricated_1st = "Fabrication" Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2 = Val(txtCrossTubeWidth.Text)    '12_07_2012   RAGAVA 
            'End If
            ''Till  Here
    ...
    Private Sub rdbUseSelectedCrossTubeYes_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbUseSelectedCrossTubeYes.CheckedChanged
        If rdbUseSelectedCrossTubeYes.Checked Then
            'ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strCast_Fabricated_1st = "Cast"      '12_07_2012   RAGAVA commented
            ''16_04_2012  RAGAVA
            'If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strCast_Fabricated_1st = "Cast" Then
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port Integral" Then
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTPortIntegral.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTPortIntegral2.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortIntegral.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortIntegral2.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2

            ElseIf ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPort = "Port In Tube" Then
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTPortInTube.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTPortInTube2.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortInTube.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortInTube2.dblCrossTubeWidth = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeWidth2
    ...
    Private Sub rdbUseSelectedCrossTubeNo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbUseSelectedCrossTubeNo.CheckedChanged
        If rdbUseSelectedCrossTubeNo.Checked Then
            'ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.strCast_Fabricated_1st = ""      '12_07_2012   RAGAVA  commented       '11_04_2012   RAGAVA
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnExistingPartSelected_BaseEnd = False        '20_10_2010    RAGAVA
...
#End Region
    ...
    Private Sub txtCrossTubeOD_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCrossTubeOD.TextChanged
        Try
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CrossTubeOD2 = Val(txtCrossTubeOD.Text)         '05_08_2011    RAGAVA
        Catch ex As Exception
