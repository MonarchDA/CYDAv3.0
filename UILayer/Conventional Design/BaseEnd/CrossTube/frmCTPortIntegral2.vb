Public Class frmCTPortIntegral2
...
#Region "Sub Procedures"
    ...
    Private Sub SearchForExistingCrossTubeCastingsFlushPort()
        ...
        Try
            ...
            Else
                pnlCasting_YesNo.Controls.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortIntegral2.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortIntegral2.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortIntegral2.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortIntegral2.Show()
                pnlCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortIntegral2)
