    ...
    Public Sub ManualLoad()
        Try
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjFrmPrimaryInputs.ChkASAE.Checked = True Then
                ...
                'End If VAMSI 28thMAY2013
                cmbDesignType.Enabled = True ' VAMSI 28thMAY2013 CHANGED TO TRUE
                cmbBaseEndConfiguration.Text = "Double Lug"
                cmbBaseEndConfiguration.Enabled = True ' VAMSI 28thMAY2013 CHANGED TO TRUE
   ...
   (ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.OrificeSize_RodEnd / 2)
    ...
    Private Sub ControlsEnabling1()
        ...
        If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.DesignType = "New" Then       '31_05_2010    RAGAVA
            cmbBaseEndPort.Items.Add("Port In Tube") 'vamsi 28th may 2013
            cmbBaseEndPort.Items.Add("Port Integral")
            cmbBaseEndPort.Enabled = True 'vamsi 28th may 2013
        ...
        If cmbBaseEndConfiguration.Text = "Plate Clevis" Then
            ...
            ChkBEPartCode.Enabled = False                 'partcode 
            txtBaseendPartCode.Enabled = False        'partcode
            'ANUP 08-11-2010 START
            'cmbPins.Items.Clear()
            'cmbPins.Items.Add("No")
        ...
        ElseIf cmbBaseEndConfiguration.Text = "Double Lug" Then
            ChkBEPartCode.Enabled = True                                       ''added to facilitate partcode for double lug
            txtLugThickness.Enabled = True
...
#Region "Events"
    ...
    Private Sub frmTubeDetails_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If ObjClsWeldedCylinderFunctionalClass.ObjFrmPrimaryInputs.ChkASAE.Checked = True Then
                ...
                'Else
                '    cmbDesignType.Text = "Conventional"
                'End If  vamsi 28MAY13
                cmbDesignType.Enabled = True 'VAMSI 28.05.13
                cmbBaseEndConfiguration.Text = "Double Lug"
                cmbBaseEndConfiguration.Enabled = True 'VAMSI 28.05.13
                txtLugGap.Text = "1.125"
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugGap = 1.125        '30_05_2012   RAGAVA
                txtLugGap.Enabled = False
                cmbBaseEndPort.Enabled = True 'vamsi 24th may 13
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BoreDiameter = 4.75 Then
                    cmbPinHoleSize.Text = "1.265"
                Else
                    cmbPinHoleSize.Text = "1.015"
    ...
    Private Sub cmbDesignType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbDesignType.SelectedIndexChanged
        ...
        ElseIf cmbDesignType.Text = "WR Cylinder" Then
            ...
            cmbBaseEndPort.Enabled = False
            cmbBaseEndPort.BackColor = Color.Empty 'vamsi 28th may 2013
            'cmbBaseEndPort.Items.Add("Port In Tube") 'vamsi 24th may 2013 vamsi 8th august 2013
            cmbBaseEndPort.Items.Add("Port Integral")
            cmbBaseEndPort.SelectedIndex = 0 'vamsi 28th may 2013
            cmbBaseEndPort.Enabled = False 'vamsi 8th august 2013
        ...
        ChkBEPartCode.Checked = False          'Priyanka partcode selection
    End Sub
...
#End Region
    ...
    Private Sub ChkBEPartCode_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkBEPartCode.CheckedChanged
        Try
            If ChkBEPartCode.Checked = True Then
                ...
                txtSwingClearance.BackColor = Color.WhiteSmoke
                txtLugThickness.Enabled = False
                txtLugThickness.Clear()
                txtLugThickness.BackColor = Color.WhiteSmoke
                txtLugGap.Enabled = False
                txtLugGap.Clear()
                txtLugGap.BackColor = Color.WhiteSmoke
                txtBaseendPartCode.Focus()
            ElseIf ChkBEPartCode.Checked = False Then
                txtBaseendPartCode.Enabled = False
                txtBaseendPartCode.BackColor = Color.WhiteSmoke
                txtBaseendPartCode.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnPrtNumChkd = False
                txtSwingClearance.Enabled = True
                txtSwingClearance.BackColor = Color.White
                txtLugThickness.Enabled = True
                txtLugThickness.BackColor = Color.White
                txtLugGap.Enabled = True
                txtLugGap.BackColor = Color.White
            End If
        Catch ex As Exception
            Exit Sub
        End Try
    ...
    Private Sub txtBaseendPartCode_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBaseendPartCode.Leave   'priyanka
        If txtBaseendPartCode.Text <> "" Then
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BEDLPartCode = Val(txtBaseendPartCode.Text)
            BaseEndpartCode()
            'BELugGap()
        Else
            If txtBaseendPartCode.Text = "" Then
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BEDLPartCode = String.Empty
                txtSwingClearance.Clear()
                txtLugThickness.Clear()
                txtLugGap.Clear()
            End If
    ...
    Private Sub BaseEndpartCode()         'priyanka
        Dim BaseendPartCode As String
        Dim Boredia As Double = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BoreDiameter
        BaseendPartCode = Val(txtBaseendPartCode.Text)
        If cmbDesignType.Text = "Conventional" Then
            If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndConfiguration = "Double Lug" Then
        ...
        If IsNothing(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data) OrElse ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows.Count = 0 Then
            ...
            txtBaseendPartCode.Focus()
        Else
            txtSwingClearance.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows(0).ItemArray(11)
            txtLugThickness.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows(0).ItemArray(6)
            txtLugGap.Text = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows(0).ItemArray(9)

            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugThickness = Val(txtLugThickness.Text)
            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.LugGap = Val(txtLugGap.Text)

            ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPinholesize = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows(0).ItemArray(14).ToString()
            Slectpinsize()
            'Dim x As Double = Math.Round((ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPinholesize - 0.015), 3)
            'cmbPinHoleSize.SelectedItem = FormatNumber(CDbl(x), 3)
            '   cmbPinHoleSize.SelectedItem = y
            If ObjClsWeldedCylinderFunctionalClass.IsPortIntegral_or_PortInTube = "Port Integral" Then
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPortSize = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows(0).ItemArray(20)
                ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPortType = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows(0).ItemArray(19)
                'ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPinholesize = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.Data.Rows(0).ItemArray(14)
    ...
    Private Sub ChkBEPartCode_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkBEPartCode.MouseHover
        Me.ToolTip1.ToolTipIcon = ToolTipIcon.Info
        Me.ToolTip1.SetToolTip(Me.ChkBEPartCode, "Check to enable Part code option")
    End Sub

    Private Sub txtBaseendPartCode_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBaseendPartCode.MouseHover
        Me.ToolTip1.ToolTipIcon = ToolTipIcon.Info
        Me.ToolTip1.SetToolTip(Me.txtBaseendPartCode, "Enter Double lug part code")
    End Sub

    Private Sub ChkBEPartCode_EnabledChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkBEPartCode.EnabledChanged
        ChkBEPartCode.Checked = False
        Me.ToolTip1.ToolTipIcon = ToolTipIcon.Info
        Me.ToolTip1.SetToolTip(Me.ChkBEPartCode, "Check to enable Part code option")
    End Sub

    Private Sub Slectpinsize()
        Dim x As String = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPinholesize.Substring(0, 3)
        For Each item As DataRowView In cmbPinHoleSize.Items
            Dim x1 As String = item.Item(0)
            If x1.StartsWith(x) = True Then
                cmbPinHoleSize.SelectedIndex = cmbPinHoleSize.Items.IndexOf(item)
            End If
        Next
    End Sub
