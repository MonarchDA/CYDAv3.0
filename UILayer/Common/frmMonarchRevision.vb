...
Public Class frmMonarchRevision
    ...
    ' ANUP 24-06-2010
    Public Sub LVCustomer_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LVCustomer.SelectedIndexChanged
        Try
    ...
    Public Sub Selectlistdata()

        Dim cnt As Integer = LVCustomer.Items.Count

        Dim y As Boolean

        For itemIndex As Integer = 0 To cnt - 1

            y = LVCustomer.Items.Item(itemIndex).Text.Equals(cName.ToString)

            If y = True Then

                LVCustomer.Items.Item(itemIndex).Selected = True
                Exit For
            End If
    ...
    Public Sub SelectListDataCode()

        Dim cnt As Integer = lvwContractDetails.Items.Count

        Dim y As Boolean

        For itemIndex As Integer = 0 To cnt - 1

            y = lvwContractDetails.Items.Item(itemIndex).Text.Equals(cNumber.ToString)

            If y = True Then

                lvwContractDetails.Items.Item(itemIndex).Selected = True
                Exit For
            End If
