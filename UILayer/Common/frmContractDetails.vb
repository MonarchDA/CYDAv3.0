Imports ExcelNew = Microsoft.Office.Interop.Excel
...
#Region "Events"
    ...
    Private Sub frmContractDetails_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ColorTheForm()
        'Dim gExcel As New GlobalExcel
        'gExcel.open()



        'custName1 = gExcel.LoadExcelData
        'MessageBox.Show("cust name is:{0}", custName1)

        'cmbCustomerName.Items.Add(custName1.ToString())
