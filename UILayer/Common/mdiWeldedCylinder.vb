...
#Region "Events"
    ...
    Private Sub mdiWeldedCylinder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedDataClass.GetConnection() Then
            '*****************
            ObjClsWeldedCylinderFunctionalClass.MonarchProgressbar = Me.prb ' vamsi
        ...
        'NewMenuItem_Click_1(sender, e) '13-11-2013
    End Sub
    ...
    Public Sub FormNavigation(ByVal sender As System.Object, ByVal eFrm As System.EventArgs) Handles btnBack.Click, btnNext.Click
        ...
        'Partcode Selction DoubleLug
        If ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.ToString.Equals(ObjClsWeldedCylinderFunctionalClass.ObjFrmPortDetails.ToString()) = True Then
            Try
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnPrtNumChkd = True And ObjClsWeldedCylinderFunctionalClass.IsPortIntegral_or_PortInTube = "Port Integral" Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmPortDetails.cmbPortTypeBaseEnd.SelectedIndex = ObjClsWeldedCylinderFunctionalClass.ObjFrmPortDetails.cmbPortTypeBaseEnd.Items.IndexOf(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPortType)
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmPortDetails.cmbPortSizeBaseEnd.SelectedIndex = ObjClsWeldedCylinderFunctionalClass.ObjFrmPortDetails.cmbPortSizeBaseEnd.Items.IndexOf(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.tmpPortSize)
                End If
            Catch ex As Exception
            End Try
        End If

        If ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.ToString.Equals(ObjClsWeldedCylinderFunctionalClass.ObjFrmDLPortIntegral.ToString()) = True And ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnPrtNumChkd = True Then
            Try
                SelectListViewData(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BEDLPartCode.ToString())
                ObjClsWeldedCylinderFunctionalClass.ObjFrmDLCastingYes.rdbExactMatchYes.Checked = True
            Catch ex As Exception
            End Try
        End If

        If ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.ToString.Equals(ObjClsWeldedCylinderFunctionalClass.ObjFrmDLPortInTubeDetails.ToString()) = True And ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnPrtNumChkd = True Then
            Try
                SelectListViewData(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BEDLPartCode.ToString())
                ObjClsWeldedCylinderFunctionalClass.ObjFrmDLCastingYes.rdbExactMatchYes.Checked = True
            Catch ex As Exception
        ...
        If ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.ToString.Equals(ObjClsWeldedCylinderFunctionalClass.ObjFrmGenerate.ToString()) Then
            If ObjClsWeldedCylinderFunctionalClass.batchrunEnable = True Then
                ObjClsWeldedCylinderFunctionalClass.ObjFrmGenerate.ChkbxBatchRun.Checked = True
            End If
        End If


        'Partcode Selection DoubleLug
    ...
    Private Function ChangeRodEndConfigScreen() As Boolean
        ...
        If ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.Name = "frmREDLThreaded" Then
            If ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.IsDLThreadDataFound = False Then
                'Dim oForm As Form = ObjClsWeldedCylinderFunctionalClass.ObjFrmRodEndConfiguration
                Dim oForm As Form = ObjClsWeldedCylinderFunctionalClass.ObjFrmPrimaryInputs 'vamsi 11-03-14
                ShowingTheForm(oForm)
        ...
        ElseIf ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.Name = "frmRECrossTube" Then
            If ObjClsWeldedCylinderFunctionalClass.ObjFrmCastingNo_RECT.IsPrimaryInputsReq = True Then
                ...
                Return True
            End If
            'vamsi 11-03-13 start
        ElseIf ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.Name = "frmPrimaryInputs" Then
            ObjClsWeldedCylinderFunctionalClass.ObjFrmREDLThreaded.SearchForExistingThreadedDoubleLug()
            If ObjClsWeldedCylinderFunctionalClass.ObjFrmREDLThreaded.IsDLThreadDataFound = True Then
                'Dim oForm As Form = ObjClsWeldedCylinderFunctionalClass.ObjFrmPin_Port_PaintAccessories
                Dim oForm As Form = ObjClsWeldedCylinderFunctionalClass.ObjFrmREDLThreaded()
                ShowingTheForm(oForm)
                Return True
            End If
            'end
...
#End Region
    ...
    Public Sub RevisionMenuItem_Click_1(ByVal sender As System.Object, ByVal erev As System.EventArgs) Handles RevisionMenuItem.Click, ReleasedMenuItem.Click
...
#Region "Batchrun_Trial1"
    Public Sub RedirectFrmRevision()

        RevisionMenuItem_Click_1(RevisionMenuItem, EventArgs.Empty)

        While ObjClsWeldedCylinderFunctionalClass.CurrentForm_Object <> "frmGenerate"

            FormNavigation(btnNext, EventArgs.Empty)

        End While

    End Sub

    Public Sub RedirectToFrmPrimary()

        While ObjClsWeldedCylinderFunctionalClass.CurrentForm_Object = "frmPrimaryInputs"

            FormNavigation(btnBack, EventArgs.Empty)
    ...
    End Sub
#End Region
#Region "Batchrun_Trial2"

    Public cNumber As String = String.Empty
    Public cName As String = String.Empty

    Public Sub GetBatchRunData()


        Dim strQuery As String
        Dim strQuery1 As String
        strQuery = "select top 1 CustomerName  from dbo.BatchRun "
        Dim dr As DataRow = MonarchConnectionObject.GetDataRow(strQuery)
        If Not dr Is Nothing AndAlso dr("CustomerName").ToString <> "" Then
            cName = dr("CustomerName").ToString
        End If

        strQuery1 = "select top 1 ContractNumber from dbo.BatchRun"
        Dim dr1 As DataRow = MonarchConnectionObject.GetDataRow(strQuery1)
        If Not dr1 Is Nothing AndAlso dr1("ContractNumber").ToString <> "" Then
            cNumber = dr1("ContractNumber").ToString
        End If
    End Sub
    ...
    Public Function BatchRunCount() As Integer
        ...
        Try
            ObjClsWeldedCylinderFunctionalClass.RowCount = MonarchConnectionObject.GetValue(strquery)
            If IsNothing(ObjClsWeldedCylinderFunctionalClass.RowCount) Then
                ObjClsWeldedCylinderFunctionalClass.RowCount = 0
            Else
                Return ObjClsWeldedCylinderFunctionalClass.RowCount
            End If
    ...
    Public lastForm As Boolean = Nothing

    Public Function CheckBatchrunstatus() As Boolean
        If ObjClsWeldedCylinderFunctionalClass.RowCount <> 0 Then
            Dim status As Boolean
            Dim strquery As String = "select  top(1) status from BatchRun"
            status = MonarchConnectionObject.GetValue(strquery)
            Return status
        End If
    End Function

    'method executes after form load event, designed for batchrun mode
    Dim CurrentFormName As String = Nothing
    Dim VirCurrentFormName As String = Nothing
    Dim FailFlag As Boolean = False
    Dim c As Integer = 0
    Public Sub ManualLoad2()
        ObjClsWeldedCylinderFunctionalClass.startTime = DateTime.Now.ToString("HH:mmm:s tt")
        BatchRunCount()
        If ObjClsWeldedCylinderFunctionalClass.RowCount <> 0 And CheckBatchrunstatus() = True Then
            ObjClsWeldedCylinderFunctionalClass.MultiGenerate = True
            Me.RevisionMenuItem.PerformClick()
            ObjClsWeldedCylinderFunctionalClass.ObjFrmMonarchRevision.Enroute()
            Do
                CurrentFormName = ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.name.ToString()
                Me.btnNext.PerformClick()
                VirCurrentFormName = ObjClsWeldedCylinderFunctionalClass.ObjCurrentForm.name.ToString()
                If VirCurrentFormName.Equals(CurrentFormName) = True Then
                    c += 1
                    If c = 2 Then
                        FailFlag = True
                        MsgBox("Unable to proceed with the current Design " + ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CodeNumber.ToString())
                        Exit Do
                    End If
                End If
                If ObjClsWeldedCylinderFunctionalClass.Fabricated_1_batchrun = True Then
                    ObjClsWeldedCylinderFunctionalClass.Fabricated_1_batchrun = False
                    ObjClsWeldedCylinderFunctionalClass.objfrmFabricatedSingleLug.btnGenerate.PerformClick()
                End If
                If ObjClsWeldedCylinderFunctionalClass.Fabricated_2_batchrun = True Then
                    ObjClsWeldedCylinderFunctionalClass.Fabricated_2_batchrun = False
                    ObjClsWeldedCylinderFunctionalClass.objfrmFabricatedSingleLug2.btnGenerate.PerformClick()
                End If
            Loop Until lastForm = True

            If FailFlag = False Then
                ObjClsWeldedCylinderFunctionalClass.ObjFrmGenerate.btnGenerateMultiple.PerformClick()
            End If

            If FailFlag = True Then
                Try
                    BatchRun.deleteBatchrunRow()
                    BatchRun.CreateLog4fail()
                    BatchRun.writelogfail()
                Catch ex As Exception
                End Try
                Application.Restart()
            End If
            ...
            'ObjClsWeldedCylinderFunctionalClass.ObjFrmGenerate.GenerateMultiple_Click(ObjClsWeldedCylinderFunctionalClass.ObjFrmGenerate.btnGenerateMultiple, EventArgs.Empty)


        End If

        If ObjClsWeldedCylinderFunctionalClass.RowCount > 0 Then
            ObjClsWeldedCylinderFunctionalClass.batchrunEnable = True
        End If

    End Sub

    'partcode selection Doublelug
    Sub SelectListViewData(ByVal ItemName As String)

        Dim cnt As Integer = ObjClsWeldedCylinderFunctionalClass.ObjFrmDLCastingYes.lvwDoubleLugListView.Items.Count
        Dim y As Boolean
        For itemIndex As Integer = 0 To cnt - 1
            y = ObjClsWeldedCylinderFunctionalClass.ObjFrmDLCastingYes.lvwDoubleLugListView.Items.Item(itemIndex).Text.Equals(ItemName.ToString)
            If y = True Then
                ObjClsWeldedCylinderFunctionalClass.ObjFrmDLCastingYes.lvwDoubleLugListView.Items.Item(itemIndex).Selected = True
                Exit For
            End If
        Next
    End Sub
