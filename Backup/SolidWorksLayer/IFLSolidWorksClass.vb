            ...
            If Not oIflBaseSolidWorksClass.SolidWorksModel Is Nothing Then
                ...
                If Not (strPart.IndexOf("PISTON") <> -1 OrElse strPart.IndexOf("CYL HEAD WIRE RING") <> -1 OrElse strPart.IndexOf("7") <> -1 OrElse strPart.IndexOf("6") <> -1 OrElse strPart.IndexOf("5") <> -1) Then
                    ...
                    Else
                        ...
                        ElseIf strPart.IndexOf(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPartName) <> -1 AndAlso Trim(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BaseEndPartName) <> "" Then    '12_10_2010   RAGAVA
        ...
        Try
            ...
            ElseIf strFileName.IndexOf("WELD_CYLINDER_ASSEMBLY") <> -1 Then
                ...
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ColumnLoadDeratePressure <> "N/A" Then
                    strGeneralNote = strGeneralNote & "Max Pressure at full extension " & ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.ColumnLoadDeratePressure.ToString & " PSI" & vbNewLine
                End If
                'Till   Here
                ...
                '26_10_2010    RAGAVA
                If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.DesignType = "New" Then
                    checkProperty("Cylinder Note", Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BoreDiameter * 10, 2).ToString + "WR" + Format(Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.StrokeLength, 2), "00.00") + "-" + (Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodDiameter, 2) * 100).ToString)      '07_07_2010    RAGAVA
                Else
                    '09_07_2011  RAGAVA
                    ...
                    If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.StrokeLength = 8 OrElse ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.StrokeLength = 16 Then
                        checkProperty("Cylinder Note", Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BoreDiameter * 10, 2).ToString + "WD" + Format(Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.StrokeLength, 2), "00") + "-" + (Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodDiameter, 2) * 100).ToString + "ASAE")
                    Else
                        checkProperty("Cylinder Note", Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BoreDiameter * 10, 2).ToString + "WD" + Format(Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.StrokeLength, 2), "00.00") + "-" + (Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodDiameter, 2) * 100).ToString)
                    End If
                    'TILL   HERE
                End If
                'checkProperty("Cylinder Note", Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.BoreDiameter * 10, 2).ToString + "WD" + Format(Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.StrokeLength, 2), "00.00") + "-" + (Math.Round(ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodDiameter, 2) * 100).ToString)      '07_07_2010    RAGAVA
