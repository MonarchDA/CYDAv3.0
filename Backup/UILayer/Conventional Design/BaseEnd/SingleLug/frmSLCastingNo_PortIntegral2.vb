Public Class frmSLCastingNo_PortIntegral2
...
#Region "SubProcedures"
    ...
    Private Sub SetValuesToPrivateVariables()
        ...
        ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortIntegral.rdbDesignACasting.Checked = True Then
        ...
        ObjClsWeldedCylinderFunctionalClass.ObjFrmSLCastingNo_PortIntegral.rdbFabricated.Checked = True Then
            rdbFabricated.Checked = False
    ...
    Private Sub LoadFunctionality()
        ...
        If rdbDesignACasting.Checked Then
            ...
            plnPortInTube_Casting.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmSLDesignACasting2)
        ElseIf rdbFabricated.Checked Then
            ...
            plnPortInTube_Casting.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmSLFabrication2)
