...
#Region "Sub Procedures"
    ...
    Private Sub SearchForExistingCrossTubeCastings()
        ...
        Try
            ...
            (ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.EndConditionSafetyFactor, False, clsWeldedCylinderFunctionalClass.YeildStrengthConstants.CrossTube_Cast_NoPort)
            dblSwingClearance = ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.SwingClearance
            ...
            Else
                pnlCasting_YesNo.Controls.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortInTube.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortInTube.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortInTube.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortInTube.Show()
                pnlCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmCTCastingNo_PortInTube)
