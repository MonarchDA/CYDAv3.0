    ...
    Private Sub SearchForExistingBHCastings()
        Try
            ...
            Else
                ...
                pnlBHCasting_YesNo.Controls.Clear()
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.TopLevel = False
                If ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.Created Then
                    ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.ManualLoad()
                End If
                ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube.Show()
                pnlBHCasting_YesNo.Controls.Add(ObjClsWeldedCylinderFunctionalClass.ObjFrmBHCastingNo_PortInTube)
