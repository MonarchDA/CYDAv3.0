...
#Region "Class Variables"
    ...
    Public ErrorMessage10 As String
...
#End Region
    ...
    Public Function GetCollarCylinderLength() As Boolean
        ...
        Catch ex As Exception
            ...
            ObjClsWeldedCylinderFunctionalClass.WriteLogInformation("Error in Retrieving CollarCylinderLength")
        End Try
    End Function
    '25_06_2010   RAGAVA
...
#End Region
    ...
    Public Function BEDLCastingWOPortDetails(ByVal strBaseEndPartCode As String, ByVal strBoreDiameter As String) As DataTable                      'priyanka
    ...
    Public Sub SaveCodeToBatchRun()
        ...
        Try
            strQuery = "Insert into BatchRun(CustomerName,ContractNumber,Status) values ('" & ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CustomerName_ContractDetails.ToString & "','" & ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.CodeNumber.ToString & "','" & falseval & "')"
