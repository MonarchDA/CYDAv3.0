...
#Region " Create Excel Functions"
    ...
    Private Function SaveExcel() As Boolean
        ...
        Try
            ...
            If Not Directory.Exists("K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\COSTING\") Then
                Directory.CreateDirectory("K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\COSTING\")
            End If
            If File.Exists(_strchildExcelPath) Then
                If File.Exists("K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\COSTING\" + _strCodeNumber + "_Costing.xls") Then
                    File.Delete("K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\COSTING\" + _strCodeNumber + "_Costing.xls")
                End If
                File.Move(_strchildExcelPath, "K:\USR\_CYLINDER\CYLOEM\IFL DWG NR\WELDED\COSTING\" + _strCodeNumber + "_Costing.xls")
            End If
    ...
    Private Sub ExistingWCData()
        ...
        Try
            ...
            Try
                ...
                If (ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.RodDiameter < 3.5 OrElse ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.Pins_RodEnd = "Yes" OrElse ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.PinsYesOrNo = "Yes") Then
                    '06_06_2011   RAGAVA
                    If ObjClsWeldedCylinderFunctionalClass.ObjClsWeldedGlobalVariables.blnInstallPinsandClips_Checked = False Then


                        dblRunCostPaintingWC = Rng.Value
                        dblRunCostPaintingWC = dblRunCostPaintingWC * 2
                        ObjClsWeldedCylinderFunctionalClass.PaintStandardCost = dblRunCostPaintingWC
                    Else
                        dblRunCostPaintingWC = Rng.Value
                        ObjClsWeldedCylinderFunctionalClass.PaintStandardCost = dblRunCostPaintingWC
                    End If
